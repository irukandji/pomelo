...
var configLogger = function(app) {
  if (process.env.POMELO_LOGGER !== 'off') {
    ...
    var originPath = path.join(app.getConfigBase(), Constants.FILEPATH.LOG);
    var presentPath = path.join(app.getConfigBase(), Constants.FILEPATH.CONFIG_DIR, env, path.basename(Constants.FILEPATH.LOG));
